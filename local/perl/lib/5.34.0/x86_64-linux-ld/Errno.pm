...
"x86_64-linux-ld-5.13.0-1022-aws" or
	die "Errno architecture (x86_64-linux-ld-5.13.0-1022-aws) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
